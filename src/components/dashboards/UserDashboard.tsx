...
import { LayoutDashboard, Ticket, LogOut, ChevronLeft, ChevronRight, HelpCircle } from 'lucide-react';
...
export default function UserDashboard({ children }: { children: React.ReactNode }) {
  ...
  // Get user's tickets
  const userTickets = tickets.filter(ticket => ticket.customerId === user.id);
                ...
                <div className="relative p-3" ref={menuRef}>
                  ...
                  >
                    ...
                    {!isCollapsed && <div className="ml-3 flex-1 text-left">
                      ...
                      <div className="text-xs text-dark-400">Customer</div>
                    </div>}
                  </button>
