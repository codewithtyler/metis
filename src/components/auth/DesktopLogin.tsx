        ...
        <div className="mx-auto w-full max-w-sm lg:w-96">
          ...
          <div className="mb-8">
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-2xl font-bold text-dark-100" tabIndex={-1}>{APP_NAME}</h1>
            </div>
            <h2 className="mt-6 text-2xl text-dark-100">
              Welcome back
            </h2>
            <p className="mt-2 text-sm text-dark-300 flex gap-2">
              New to our platform?
              <Link to="/signup" className="text-dark-200 hover:text-dark-100 font-medium transition-colors duration-150" tabIndex={4}>
                Create an account
              </Link>
            </p>
          </div>
